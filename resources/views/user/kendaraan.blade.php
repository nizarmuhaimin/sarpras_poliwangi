        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Kendaraan Dinas</h1>
                ...
                <div class="row">
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 mt-5">
                          <h3 Style="color:black" class="text-center mb-5"><b>Daftar Kendaraan Dinas</b></h3>
                          <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                            ...
                            <div class="col mb-5">
                              <div class="card h-100">
                               ...
                               {{-- @else --}}
                               <img class="card-img-top" style="height: 200px; width 350px; object-fit: cover"src="{{asset('img/mobilio.jpeg')}}" alt="...">
                               ...
                               {{-- @endif --}}
                                ...
                                <div class="card-body card-body-custom pt-4">
                                  <div class="text-center">
                                    ...
                                    <span>Honda Mobilio</span>
                                    <div style="font-family: ;
                                    font-weight: ExtraBold;
                                    font-size: 20px; color:black;">
                                    <span>DK 4003 KC</span>
                                    </div>
                                    </div>
                                  </div>
                                </div>
