                ...
                <div class="row">
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 mt-5">
                          <h3 Style="color:black" class="text-center mb-5"><b>Pengembalian Kendaraan Dinas</b></h3>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-12">
                                                      <div class="p-5">
                                                          ...
                                                          <form style="color:black;" action="{{ route('user.dikembalikan_create') }}" method="post" class="user">
                                                            @csrf
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                              ...
                                                              <div     class="form-group">
                                                                ...
                                                                <select id="sarana_id" class="form-select form-control" name="sarana_id" >
                                                                    <option>Pilih Kendaraan Dinas yang Dikembalikan</option>
                                                            ...
                                                            <div class="form-group row">
                                                              ...
                                                              <div class="">
                                                              <input type="file" class="form-control" name="foto_akhir" id="foto_akhir" placeholder="Foto">
                                                            </div>
                                                            <div class="mb-3">
