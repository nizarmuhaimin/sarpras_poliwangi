                ...
                <div class="row">
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 mt-5">
                          <h3 Style="color:black" class="text-center mb-5"><b>Pengembalian Sarana Prasarana</b></h3>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-12">
                                                      <div class="p-5">
                                                          ...
                                                          <form style="color:black;" action="{{ route('user.pengembalian_create') }}" method="post" class="user">
                                                            @csrf
                                                            <div class="mb-3">
                                                              <label for="nim" class="form-label">NIM/NIK/NIP/NIPPPK</label>
                                                              <input type="text" class="form-control" name="nim" id="nim" placeholder="NIM/NIK/NIP/NIPPPK">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                              ...
                                                              <input type="datetime-local" class="form-control" name="tgl_waktu_peminjaman" id="exampleFormControlInput1" placeholder="Tanggal Peminjaman">
                                                            </div>
                                                            <div class="mb-3">
                                                              <label for="tgl_waktu_pengembalian" class="form-label">Tanggal & Waktu Pengembalian</label>
                                                              <input type="datetime-local" class="form-control"name="tgl_waktu_pengembalian" id="tgl_waktu_peminjaman" placeholder="Tanggal Pengembalian">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                              <label for="sarpras_id" class="form-label">Sarpras Id</label>
                                                              {{--<input type="text" class="form-control" name="sarpras_id" id="sarpras_id" placeholder="Sarpras Id">--}}
                                                              <div     class="form-group">
                                            
                                                                <select id="sarana_id" class="form-select form-control" name="sarana_id" >
                                                                    <option>Pilih Sarana yang Dikembalikan</option>
                                                            ...
                                                            <div class="form-group row">
                                                              <label for="foto_akhir" class="form-label">Foto Tampak Akhir</label>
                                                              <div class="">
                                                                <input type="file" class="form-control" name="foto_akhir" id="inputPassword3" placeholder="Foto">
                                                              </div>
                                                            </div>
                                                            <div class="mb-3">
