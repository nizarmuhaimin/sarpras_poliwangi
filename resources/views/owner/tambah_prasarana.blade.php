                ...
                <div class="row">
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 mt-5">
                          <h3 Style="color:black" class="text-center mb-5"><b>Tambah Data Prasarana</b></h3>
                                                      ...
                                                      <div class="p-5">
                                                          ...
                                                          <form style="color:black;" action="{{ route('owner.kelola_create') }}" method="post" class="user">
                                                                  ...
                                                                  <div hidden class="mb-3">
                                                                    ...
                                                                    <input value='kosong' type="" class="form-control" name="nama_sarana" id="nama_sarana" placeholder="Nama Sarana" >
                                                                  </div>                                                              
                                                                  <div class="mb-3">
                                                                  ...
                                                                  <div hidden class="mb-3">
                                                                    ...
                                                                    <input value='kosong' type="" class="form-control" name="nama_kendaraan" id="nama_kendaraan" placeholder="Nama Sarana" >
                                                                  </div>
                                                                  <div class="mb-3">
                                                                  ...
                                                                  <div hidden class="mb-3">
                                                                    ...
                                                                    <input value='kosong' type="text" class="form-control" name="nopol" id="nopol" placeholder="Foto Sarana">
                                                                  </div>
                                                                  <div class="mb-3">
                                                                  ...
                                                                  <div hidden class="mb-3">
                                                                    ...
                                                                    <input value='kosong' type="text" class="form-control" name="jenis" id="jenis" placeholder="Foto Sarana">
                                                                  </div>
                                                                  <div hidden class="mb-3">
                                                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                                                    <input value='kosong' type="text" class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi">
                                                                  </div>
                                                                  <div hidden class="mb-3">
                                                                    <label for="stok_awal" class="form-label">Stok Awal</label>
                                                                    <input value='kosong' type="text" class="form-control" name="stok_awal" id="stok_awal" placeholder="Stok Awal">
                                                                  </div>
                                                                  <div hidden class="mb-3">
                                                                    <label for="stok_tersedia" class="form-label">Stok Tersedia</label>
                                                                    <input value='kosong' type="text" class="form-control" name="stok_tersedia" id="stok_tersedia" placeholder="Stok Tersedia">
                                                                  </div>
