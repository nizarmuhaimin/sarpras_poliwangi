                ...
                <div class="row">
                    <section class="py-5">
                        <div class="container px-4 px-lg-5 mt-5">
                          <h3 Style="color:black" class="text-center mb-5"><b>Peminjaman Prasarana</b></h3>
                                                  ...
                                                  <div class="col-lg-12">
                                                      <div class="p-5">
                                                          ...
                                                          <form style="color:black;" action="{{ route('login') }}" method="post" class="user">
                                                            @csrf
                                                            <div class="mb-3">
                                                              <label for="exampleFormControlInput1" class="form-label">NIM/NIK/NIP/NIPPPK</label>
                                                              <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="NIK/NIK/NIP/NIPPPK">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                              <label for="exampleFormControlInput1" class="form-label">Tanggal & Waktu Peminjaman</label>
                                                              <input type="datetime-local" class="form-control" id="exampleFormControlInput1" placeholder="Tanggal Peminjaman">
                                                            </div>
                                                            <div class="mb-3">
